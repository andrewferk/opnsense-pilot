...
- The copyright line names the author, not the project, because the name "OPNsense Pilot" is used under the OPNsense trademark policy pending Deciso's permission and may change (see [ADR 0007](0007-project-name-under-the-opnsense-trademark-policy.md)). The notices file carries the non-affiliation disclaimer.
